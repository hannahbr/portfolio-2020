...
const content = {
  ...
  sections: [
    <>
      <H3>Delivery</H3>
      <P>
        This was a fantastic project in that we were able to commit to a pretty
        comprehensive research phase before starting to define solutions.
      </P>
      <ul>
      ...
      <P>
        ...
        groups that would interact with the website, and the general perception
        of Durham for prospective students. Using this information, we
        synthesised our findings and delivered:
      </P>
      <ul>
      ...
      <ul>
        <li>
          ...
          could be helped by displaying a more diverse, inclusive view from the
          new website.
        </li>
        <li>
          Conflicting opinions throughout the uni on what should be prioritised
          as content, resulting in overwhelming page structures.
        </li>
        <li>
      ...
      <P>
        ...
        by running 6x 1 week sprints; delivering new wireframes and page tables
        each week, which gave the busy team at Durham time to properly circulate
        and sign off.
      </P>
      <ul>
      ...
      <ul>
        ...
        <li>Tree testing</li>
        <li>
          Lab testing (with 5x users, using eye tracking technology. The testing
          was conducted by another member of my team; I helped set up, plan,
    ...
    <>
      ...
      <P>
        Main focus was for prospective Durham students, however the site is also
        used by a variety of other audiences, such as current students, staff/
        academics and media.
      </P>
    </>,
    <>
      ...
      <P>
        ...
        year, so there was a challenge to finding participants for testing. For
        example, the guerrilla research was never part of the initial plan and
        we had to improvise on the day as no students had been able to be
